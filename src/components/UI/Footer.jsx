...
function Footer() {
  ...
  return (
    <footer className="relative border-t border-(--primary)/20 bg-surface">
        ...
        <div className="grid gap-10 md:grid-cols-4">
            ...
            <div className="mt-6 flex items-center gap-3">
              {[
                ...
                },
                {
                  ...
                  icon: (
                    <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current">
                      <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.48V13.2a8.19 8.19 0 005.58 2.17v-3.44a4.85 4.85 0 01-2-.31V6.69h2z" />
                    </svg>
                  ),
                },
                {
          ...
          <div>
            ...
            <form
              ...
              className="flex overflow-hidden rounded-full border border-(--primary)/30 bg-surface/40"
            >
              <input
                type="email"
