...
export default function ContactSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/3 w-125 h-100 rounded-full blur-[130px] pointer-events-none bg-primary/4" aria-hidden="true" />
      <div className="absolute top-0 right-0 w-75 h-75 rounded-full blur-[100px] pointer-events-none bg-primary/3" aria-hidden="true" />
